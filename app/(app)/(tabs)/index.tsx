  ...
  return (
    ...
    >
      <ThemedView style={styles.titleContainer}>
        <ThemedText type="title" onPress={() => router.push("/modal")}>
          Welcome! Go Products Page
        </ThemedText>
        <HelloWave />
      </ThemedView>
      ...
      <ThemedView style={styles.stepContainer}>
        ...
        <ThemedText>
          ...
          <ThemedText type="defaultSemiBold">npm run reset-project</ThemedText> to get a fresh <ThemedText type="defaultSemiBold">app</ThemedText> directory. This will move the
